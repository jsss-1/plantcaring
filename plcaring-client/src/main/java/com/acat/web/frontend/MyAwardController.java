...
import com.acat.dto.UserAwardMapExecution;
import com.acat.entity.userEntity.shoppingCenter.Award;
import com.acat.entity.userEntity.shoppingCenter.PersonInfo;
import com.acat.entity.userEntity.shoppingCenter.Shop;
import com.acat.entity.userEntity.shoppingCenter.UserAwardMap;
import com.acat.enums.UserAwardMapStateEnum;
import com.acat.service.AwardService;
import com.acat.service.PersonInfoService;
import com.acat.service.UserAwardMapService;
import com.acat.util.CodeUtil;
import com.acat.util.HttpServletRequestUtil;
import com.acat.util.ShortNetAddressUtil;
...
public class MyAwardController {
	...
	private void generateQRCode4Product(HttpServletRequest request, HttpServletResponse response) {
		...
		PersonInfo user = (PersonInfo) request.getSession().getAttribute("user");
		// 空值判断
		if (userAwardMap != null && user != null
