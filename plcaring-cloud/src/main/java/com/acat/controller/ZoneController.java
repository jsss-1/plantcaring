...
public class ZoneController extends BaseController {
    ...
    @RequestMapping("all_date")
    public Result<List<ZoneDateVo>> getAllDate(){
        List<ZoneDateVo> allDate = zoneService.getAllDate();
    ...
    @RequestMapping("get_date_by_zoneId")
    public Result<ZoneDateVo> getDateByZoneId(Integer zoneId){
        ZoneDateVo zone = zoneService.getDateByZoneId(zoneId);
        return new Result<>(OK,zone);
    }
